...
Por ejemplo, si se ingresa 10, la nota debe ser ingresada nuevamente hasta que el usuario ingrese un número comprendido entre 0 y 10."""

nota = float(input("Ingrese la nota: "))

while nota < 0 or nota > 10:
    nota = float(input("Ingrese la nota válida: "))
